...
* **[02.06.2026]**  🏷️ Released VGGSounder **v1.0** with a label-quality pass: ~3,600 noisy samples were re-reviewed by human annotators and a new Dawid-Skene merging algorithm. You can still use the previous labels via `pip install vggsounder==0.1.6` or by passing `csv_path` to an older label file. See the [release notes](https://github.com/Bizilizi/VGGSounder/releases/tag/1.0) for details.
